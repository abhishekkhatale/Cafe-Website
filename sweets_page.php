...
?>
<script>
    var coldCoffeeData = <?php echo json_encode($sweet); ?>;
</script>
    ...
    <div class="main-content">
        ...
        <div class="product-grid">
            ...
            for ($i = 0; $i < count($sweet); $i++) {
                $imageName = './stocks/menu/MENU_img/Sweets/' . $sweet[$i]['imgurl'] . '.jpg';
                $price = $sweet[$i]['price'];
                echo '
                <div class="card">
                    <div class="card-image">
                        <img src="' . $imageName . '" alt="' . $sweet[$i]['name'] . '" class="product-image" onclick="openModal(' . $i . ')">
                        <h2 class="coffee-break">Sweet Indulgence</h2>
                        <span class="discount">SAVE UP TO ' . $sweet[$i]['discount'] . '%</span>
                    </div>
                    <div class="card-content">
                        <div class="product-name-veg-icon">
                            <h3 class="product-name" onclick="openModal(' . $i . ')">' . $sweet[$i]['name'] . '</h3>
                            <span class="veg-icon"><img src="./menu_visual/veg.png" alt=""></span>
                        </div>
                        <p class="offer">' . $sweet[$i]['desc'] . '</p>
