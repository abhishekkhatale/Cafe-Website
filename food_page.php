...
?>
<script>
    var coldCoffeeData = <?php echo json_encode($food); ?>;
</script>
...
<head>
    ...
    <script>
        ...
        window.onload = function () { changeTitle("Foods"); };
    </script>
    <script>
        tailwind.config = {
            theme: {
...
<?php include_once("./nav.php") ?>  
    ...
    <div class="category-menu">
            ...
            <a href="food_page.php">
                <img src=".\stocks\menu\status4.jpg" alt="Food" class="category-image arc">
                </a>
        ...
        <div class="product-grid">
            ...
            for ($i = 0; $i < count($food); $i++) {
                $imageName = './stocks/menu/MENU_img/foods/' . $food[$i]['imgurl'] . '.jpg';
                $price = $food[$i]['price'];
                echo '
                <div class="card">
                    <div class="card-image">
                        <img src="' . $imageName . '" alt="' . $food[$i]['name'] . '" class="product-image" onclick="openModal(' . $i . ')">
                        <h2 class="coffee-break">Flavorful bites</h2>
                        <span class="discount">SAVE UP TO ' . $food[$i]['discount'] . '%</span>
                    </div>
                    <div class="card-content">
                        <div class="product-name-veg-icon">
                            <h3 class="product-name" onclick="openModal(' . $i . ')">' . $food[$i]['name'] . '</h3>
                            <span class="veg-icon"><img src="./menu_visual/veg.png" alt=""></span>
                        </div>
                        <p class="offer">' . $food[$i]['desc'] . '</p>
